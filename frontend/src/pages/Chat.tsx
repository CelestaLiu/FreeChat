...
const Chat = () => {
  ...
  return <Box sx={{display: 'flex', flex: 1, width: '100%', height: '100%', mt: 3, gap: 3}}>
    ...
    <Box sx={{display: "flex", flex:{md: 0.8, xs: 1, sm: 1}, flexDirection: 'column', px: 3}}>
      ...
      <Box sx={{width: "100%", height: "60vh", borderRadius: 3, mx: "auto", display: 'flex', flexDirection: "column", overflow: 'scroll', overflowX: "hidden", overflowY: "auto", scrollBehavior: "smooth"}}></Box>
    </Box>
  </Box>
}
